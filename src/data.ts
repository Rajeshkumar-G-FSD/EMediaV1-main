...
export const SHOWCASE_CONTENT: Record<string, ShowcaseContent> = {
  c1: {
    ...
    gallery: [
      ...
      'https://images.unsplash.com/photo-1527529482837-4698179dc6ce?w=800&auto=format&fit=crop&q=60',
      'https://images.unsplash.com/photo-1508997449629-303059a039c0?w=800&auto=format&fit=crop&q=60',
      'https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?w=800&auto=format&fit=crop&q=60',
      'https://images.unsplash.com/photo-1470753937643-efeb931202a9?w=800&auto=format&fit=crop&q=60',
  ...
  c4: {
    ...
    gallery: [
      ...
      'https://images.unsplash.com/photo-1591604466107-ec97de577aff?w=800&auto=format&fit=crop&q=60',
  ...
  c6: {
    ...
    gallery: [
      ...
      'https://images.unsplash.com/photo-1523580494863-6f3031224c94?w=800&auto=format&fit=crop&q=60',
      'https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=800&auto=format&fit=crop&q=60',
      'https://images.unsplash.com/photo-1497215842964-222b430dc094?w=800&auto=format&fit=crop&q=60',
