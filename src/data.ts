...
export const SHOWCASE_CONTENT: Record<string, ShowcaseContent> = {
  c1: {
    ...
    gallery: [
      ...
      '/images/Emedia_birthday_ballon_carnishpark_decoration.jpg',
      '/images/Emedia_birthday_chottabeem_ballon_decor.jpg',
      '/images/emedia_birthday_decoration.jpg',
      '/images/Emedia_birthday_pink_ballon_decorations_theme.jpg',
      '/images/emedia_kid_birthday_decorations.jpg',
      '/images/Emedia_pink_ballon_birthday_decoration_pink.jpg',
      '/images/Emedia_birthday_golden_ballon_black_red_decorations_theme.jpg',
      '/images/Emedia_birthday_golden_ballon_decorations_golden_pink_theme.jpg',
      '/images/Emedia_birthday_golden_ballon_decorations_themes.jpg',
      '/images/Emedia_birthday_golden_ballon_silver_reddecorations_theme.jpg',
      '/images/Emedia_birthday_golden_birthday_ballon_red_blackdecorations_theme.jpg.jpg',
      '/images/Emedia_birthday_golden_birthday_miniature_decorations_theme.jpg',
  ...
  c4: {
    ...
    gallery: [
      ...
      '/images/Emedia_wedding_flower_decorations.jpg',
  ...
  c5: {
    ...
    gallery: [
      ...
      'https://images.unsplash.com/photo-1560439514-4e9645039924?w=800&auto=format&fit=crop&q=60',
      ...
      'https://images.unsplash.com/photo-1583394293214-28ded15ee548?w=800&auto=format&fit=crop&q=60',
  ...
  c6: {
    ...
    gallery: [
      ...
      '/images/Emedia_event_bajaj_corporate.jpg',
      '/images/Emedia_event_bharath_corporate.jpg',
      '/images/Emedia_event_kia_independenceday_ballon_decoration_corporate.jpg',
      '/images/Emedia_event_bank_corporate.jpg',
  ...
  c7: {
    ...
    gallery: [
      ...
      '/images/Emediaevnt_stage_wedding_decorations.png',
      '/images/Emediaevnt_wedding_decoration.png',
      '/images/EMedia_wedding_stage_flower_decors.jpg',
      '/images/EMedia_wedding_garden_flower_decors.jpg',
      '/images/EMedia_wedding_rose_flower_decors.jpg',
      '/images/EMedia_wedding_golden_stage_flower_decors.jpg',
      '/images/EMedia_weddin_arch_flower_decors.jpg',
      '/images/EMedia_weddin_goldenlight_flower_decors.jpg',
      '/images/EMedia_weddin_entrance_flower_decors.jpg',
    ],
  },
  c8: {
    ...
    gallery: [
      ...
      '/images/Emedia_flx_banner_cook.jpg',
      '/images/Emedia_flx_banner_cook_registration.jpg',
      '/images/Emedia_flx_banner_cook_event_stage.jpg',
      '/images/Emedia_flx_banner_cook_event_decorations.jpg',
  ...
  c9: {
    tagline: 'Erode’s Colourful Balloon Decoration Experts',
    heroSubtitle: 'Balloon Arches, Walls & Themed Installations in Erode',
    intro: [
      'EMedia Event & Promotions designs vibrant balloon decorations across Erode — from full balloon walls and grand entrance arches to themed clusters for birthdays, corporate launches, and every celebration in between.',
      'Our team works with premium latex and foil balloons in curated colour palettes, building sturdy columns, ceiling drapes, and photo-ready backdrops that hold their shape and shine through the entire event.',
    ],
    highlights: [
      'Balloon walls, arches & entrance clusters',
      'Custom colour themes for any occasion',
      'Sturdy columns and ceiling drape installations',
      'Add-on toy, foil & LED balloon accents',
      'Setup handled fully on-site across Erode',
    ],
    gallery: [
      '/images/Emedia_ballon_decoration_carnish_park.jpg',
      '/images/Emedia_ballon_decoration_fridechicken.jpg',
      '/images/Emedia_ballon_decoration_wall-yellow.jpg',
      '/images/Emedia_ballon_decoration_wall.jpg',
      '/images/Emedia_ballon_mixed_ballon_decorations_theme.jpg',
      '/images/Emedia_ballon_yellow_theme_jktyers.jpg',
      '/images/Emedia_balloon_toy_decoration.jpg',
      '/images/Emedia_golden_ballon_decorations_purple_themes.jpg',
      '/images/Emedia_golden_ballon_decorations_theme.jpg',
      '/images/Emedia_grren_blue_ballon_decorations_theme.jpg',
      '/images/Emedia_office_ballon_decorations.jpg',
      '/images/Emedia_birthday_blue_ballon_decorations_theme.jpg',
      '/images/Emedia_birthday_golden_animation_ballon_decorations_theme.jpg',
      '/images/Emedia_birthday_golden_ballon_silver_swtage_ecorations_theme.jpg',
